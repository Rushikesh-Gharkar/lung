"""
=============================================================
 Lung Cancer Detection — Step 1: Data Exploration (EDA)
=============================================================
Dataset : 3-class Lung CT Scans
Classes : Normal (409) | Malignant (561) | Benign (120)
Images  : 512x512 RGB JPEG → will resize to 224x224

What this script does:
  1. Count images per class
  2. Check image sizes, modes, file sizes
  3. Plot class distribution (bar + pie chart)
  4. Display sample images grid (4 per class)
  5. Pixel intensity distribution per class
  6. Check for corrupt/unreadable images
"""
